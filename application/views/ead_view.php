...
<div id="descSummary">
	<?php foreach ($xml->xpath("//archdesc") as $info) { ?>
		...
		<button type="submit" class="btn btn-primary"><a href='<?php echo base_url("exploro/viewCollectionEAD"). "/".$cid ;?>' target='_blank' style='text-decoration: none; color: #ffffff;'>Collection Page</a></button>
	<?php } ?>
